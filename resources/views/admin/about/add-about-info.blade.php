	...
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row align-items-center">
				<div class="col">
					<h3 class="page-title">Add About Info</h3>
					<ul class="breadcrumb">
		...
		<div class="row">
			<div class="col-xl-10 d-flex offset-1">
				<div class="card flex-fill">
					...
					<div class="card-body">
						<form action="{{ url('dashboard/about/add-about-info') }}" method="POST" enctype="multipart/form-data" id="form">
							...
							<div class="form-group row">
								...
								<div class="col-lg-9">
									<div class="about_img_holder"></div>
									<input type="file" class="form-control" name="about_img" value="{{ old('description') }}">
									<div class="mt-2 text-danger">@error('about_img') {{ $message }} @enderror</div>
								</div>
							</div>
